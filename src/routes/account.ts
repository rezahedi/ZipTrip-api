...
import { fetchAllPlans, createNewPlan, fetchPlan, updatePlan, deletePlan } from '../controllers/account'
...
router.route('/:planId').get(fetchPlan).put(updatePlan).delete(deletePlan)
